# `catto` 😺🖥️
The C runtime library for the [atto programming language](https://atto.devicefuture.org). It's used by the [DigiCron smartwatch](https://github.com/devicefuture/digicron) and [atto.js](https://github.com/devicefuture/atto.js).
