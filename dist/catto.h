...
#define CATTO_SAFETY_BUFFER_SIZE 512
...
CATTO_FN_PREFIX catto_Bool catto_init() {
...
CATTO_FN_PREFIX void* catto_safeMallocFallback(catto_Count size, catto_Count fallbackSize) {
...
CATTO_FN_PREFIX void* catto_safeMalloc(catto_Count size) {
    return catto_safeMallocFallback(size, size);
}

CATTO_FN_PREFIX void* catto_safeReallocFallback(void* ptr, catto_Count size, catto_Count fallbackSize) {
...
CATTO_FN_PREFIX void* catto_safeRealloc(void* ptr, catto_Count size) {
...
CATTO_FN_PREFIX cattox_Extension* cattox_newExtension(catto_Context* context, const catto_Char* name) {
...
CATTO_FN_PREFIX cattox_Extension* cattox_findExtension(catto_Context* context, const catto_Char* name, catto_Bool useAlias) {
...
CATTO_FN_PREFIX catto_Char* catto_getIdentifierName(catto_AstNode* astNode) {
    if (!astNode) {
        return CATTO_NULL;
    }
...
CATTO_FN_PREFIX catto_AstNode* catto_getPenultimateArg(catto_Context* context) {
    catto_AstNode* currentArgument = context->nextParsedArgument;
...
CATTO_FN_PREFIX catto_TypedValue catto_evalPenultimateArg(catto_Context* context) {
    return catto_evalExpression(context, catto_getPenultimateArg(context));
}

CATTO_FN_PREFIX catto_AstNode* catto_getLastArg(catto_Context* context) {
    catto_AstNode* currentArgument = context->nextParsedArgument;
    catto_AstNode* lastArgument = CATTO_NULL;
...
CATTO_FN_PREFIX catto_TypedValue catto_evalLastArg(catto_Context* context) {
...
CATTO_FN_PREFIX catto_Token* catto_matchStrings(catto_Context* context, const catto_Char** matchStrings, catto_TokenType type, catto_Bool caseInsensitive, const catto_Char* code, catto_Count* indexPtr, catto_Token** currentTokenPtr) {
    catto_Count index = *indexPtr;
    catto_Count i = 0;
...
CATTO_FN_PREFIX void catto_command_extload(catto_Context* context) {
...
// src/extensions/test.h

#ifndef CATTOX_NO_TEST

CATTO_FN_PREFIX void cattox_test_hello(catto_Context* context) {
    CATTO_LOG("Hi there!\n");
}

CATTO_FN_PREFIX void cattox_test_add(catto_Context* context) {
    catto_Float a = catto_asNumber(catto_evalNextArg(context));
    catto_Float b = catto_asNumber(catto_evalNextArg(context));
    catto_Char* identifier = catto_getIdentifierName(catto_getNextArg(context));
...
CATTO_FN_PREFIX void cattox_test_init(catto_Context* context) {
...
// src/extensions/csv.h

#ifndef CATTOX_NO_CSV

CATTO_FN_PREFIX catto_Char* _cattox_csv_formatValue(catto_TypedValue value) {
    switch (value.type) {
...
CATTO_FN_PREFIX catto_Char* _cattox_csv_fromlist(catto_List* list) {
...
CATTO_FN_PREFIX void cattox_csv_fromlist(catto_Context* context) {
    catto_TypedValue listValue = catto_evalNextArg(context);
    catto_Char* identifier = catto_getIdentifierName(catto_getNextArg(context));
...
CATTO_FN_PREFIX catto_Bool _cattox_csv_parseNextValue(catto_Char* csv, catto_Count* indexPtr, catto_Char** valuePtr, catto_DataType* returnDataType) {
    catto_Char* value = catto_copyString("");
...
CATTO_FN_PREFIX void cattox_csv_tolist(catto_Context* context) {
...
CATTO_FN_PREFIX void _cattox_csv_intolist(catto_Context* context, catto_Char* csv, catto_List* list) {
...
CATTO_FN_PREFIX void cattox_csv_intolist(catto_Context* context) {
    catto_Char* csvString = catto_asString(catto_evalNextArg(context));
    catto_AstNode* listArg = catto_getLastArg(context);
    catto_TypedValue listValue = catto_evalExpression(context, listArg);
...
CATTO_FN_PREFIX void cattox_csv_init(catto_Context* context) {
